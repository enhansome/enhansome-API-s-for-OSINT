...
| HackerNews                     | <https://github.com/HackerNews/API> ⭐ 13,279 \| 🐛 5 \| 📅 2025-01-01 | Social news for CS and entrepreneurship                                                           | FREE  |
...
| Name          | Link                                                                                                   | Description                                                                   | Price |
| ------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----- |
| TikTok        | <https://github.com/davidteather/TikTok-Api> ⭐ 6,595 \| 🐛 152 \| 🌐 Python \| 📅 2026-08-24           | The Unofficial TikTok API Wrapper In Python                                   | FREE  |
...
| YouTube Music | <https://github.com/sigma67/ytmusicapi> ⭐ 2,964 \| 🐛 42 \| 🌐 Python \| 📅 2026-08-27                 | Unofficial APi for YouTube Music                                              | FREE  |
...
| Discord       | <https://github.com/discordjs/discord.js> ⭐ 26,802 \| 🐛 157 \| 🌐 TypeScript \| 📅 2026-08-27         | JavaScript library for interacting with the Discord API                       | FREE  |
...
| Name               | Link                                                                                                                        | Description                                                                                                                                                         | Price                |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Jackett            | <https://github.com/Jackett/Jackett> ⭐ 15,965 \| 🐛 205 \| 🌐 C# \| 📅 2026-08-27                                           | API for automate searching in different torrent trackers                                                                                                            | FREE                 |
...
| Torrentinim        | <https://github.com/sergiotapia/torrentinim> ⭐ 825 \| 🐛 9 \| 🌐 Nim \| 📅 2024-01-29                                       | Very low memory-footprint, self hosted API-only torrent search engine. Sonarr + Radarr Compatible, native support for Linux, Mac and Windows.                       | FREE                 |
...
| ---------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Keyhacks         | <https://github.com/streaak/keyhacks> ⭐ 6,323 \| 🐛 45 \| 📅 2026-08-07        | Keyhacks is a repository which shows quick ways in which API keys leaked by a bug bounty program can be checked to see if they're valid. |
...
| Public APIs Github repo | <https://github.com/public-apis/public-apis> ⭐ 471,664 \| 🐛 1,792 \| 🌐 Python \| 📅 2026-08-26 |             |

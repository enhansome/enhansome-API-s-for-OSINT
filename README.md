...
| Arquivo.pt API                                                                   | <https://github.com/arquivo/pwa-technologies/wiki/Arquivo.pt-API> ⭐ 52 \| 🐛 155 \| 📅 2026-07-15                    | Allows full-text search and access preserved web content and related metadata. It is also possible to search by URL, accessing all versions of preserved web content. API returns a JSON object. | FREE  |
...
| PicImageSearch                   | <https://github.com/kitUIN/PicImageSearch> ⭐ 721 \| 🐛 5 \| 🌐 Python \| 📅 2026-08-15                    | Aggregator for different Reverse Image Search API                                                                                                                                                | FREE? (no official)                |
...
| HackerNews                     | <https://github.com/HackerNews/API> ⭐ 13,259 \| 🐛 5 \| 📅 2025-01-01 | Social news for CS and entrepreneurship                                                           | FREE  |
...
| Name          | Link                                                                                                   | Description                                                                   | Price |
| ------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----- |
| TikTok        | <https://github.com/davidteather/TikTok-Api> ⭐ 6,576 \| 🐛 152 \| 🌐 Python \| 📅 2026-07-03           | The Unofficial TikTok API Wrapper In Python                                   | FREE  |
...
| YouTube Music | <https://github.com/sigma67/ytmusicapi> ⭐ 2,949 \| 🐛 41 \| 🌐 Python \| 📅 2026-08-17                 | Unofficial APi for YouTube Music                                              | FREE  |
...
| Instagram     | <https://github.com/ping/instagram_private_api> ⭐ 3,298 \| 🐛 160 \| 🌐 Python \| 📅 2024-05-06        | Instagram Private API                                                         | FREE  |
| Discord       | <https://github.com/discordjs/discord.js> ⭐ 26,790 \| 🐛 158 \| 🌐 TypeScript \| 📅 2026-08-17         | JavaScript library for interacting with the Discord API                       | FREE  |
...
| PornHub       | <https://github.com/sskender/pornhub-api> ⭐ 457 \| 🐛 7 \| 🌐 Python \| 📅 2023-12-30                  | Unofficial API for PornHub in Python                                          | FREE  |
...
| Name               | Link                                                                                                                        | Description                                                                                                                                                         | Price                |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Jackett            | <https://github.com/Jackett/Jackett> ⭐ 15,916 \| 🐛 205 \| 🌐 C# \| 📅 2026-08-20                                           | API for automate searching in different torrent trackers                                                                                                            | FREE                 |
...
| ---------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Keyhacks         | <https://github.com/streaak/keyhacks> ⭐ 6,317 \| 🐛 47 \| 📅 2026-08-07        | Keyhacks is a repository which shows quick ways in which API keys leaked by a bug bounty program can be checked to see if they're valid. |
...
| Public APIs Github repo | <https://github.com/public-apis/public-apis> ⭐ 466,677 \| 🐛 1,707 \| 🌐 Python \| 📅 2026-08-19 |             |

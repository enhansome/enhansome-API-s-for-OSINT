...
| PicImageSearch                   | <https://github.com/kitUIN/PicImageSearch> ⭐ 719 \| 🐛 4 \| 🌐 Python \| 📅 2026-08-12                    | Aggregator for different Reverse Image Search API                                                                                                                                                | FREE? (no official)                |
...
| HackerNews                     | <https://github.com/HackerNews/API> ⭐ 13,256 \| 🐛 5 \| 📅 2025-01-01 | Social news for CS and entrepreneurship                                                           | FREE  |
...
| Name          | Link                                                                                                   | Description                                                                   | Price |
| ------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----- |
| TikTok        | <https://github.com/davidteather/TikTok-Api> ⭐ 6,564 \| 🐛 151 \| 🌐 Python \| 📅 2026-07-03           | The Unofficial TikTok API Wrapper In Python                                   | FREE  |
...
| YouTube Music | <https://github.com/sigma67/ytmusicapi> ⭐ 2,939 \| 🐛 43 \| 🌐 Python \| 📅 2026-08-14                 | Unofficial APi for YouTube Music                                              | FREE  |
...
| Discord       | <https://github.com/discordjs/discord.js> ⭐ 26,783 \| 🐛 157 \| 🌐 TypeScript \| 📅 2026-08-14         | JavaScript library for interacting with the Discord API                       | FREE  |
...
| Name               | Link                                                                                                                        | Description                                                                                                                                                         | Price                |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Jackett            | <https://github.com/Jackett/Jackett> ⭐ 15,879 \| 🐛 204 \| 🌐 C# \| 📅 2026-08-14                                           | API for automate searching in different torrent trackers                                                                                                            | FREE                 |
...
| ---------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Keyhacks         | <https://github.com/streaak/keyhacks> ⭐ 6,314 \| 🐛 47 \| 📅 2026-08-07        | Keyhacks is a repository which shows quick ways in which API keys leaked by a bug bounty program can be checked to see if they're valid. |
...
| Public APIs Github repo | <https://github.com/public-apis/public-apis> ⭐ 456,971 \| 🐛 1,640 \| 🌐 Python \| 📅 2026-08-13 |             |

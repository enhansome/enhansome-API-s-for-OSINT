...
| Arquivo.pt API                                                                   | <https://github.com/arquivo/pwa-technologies/wiki/Arquivo.pt-API> ⭐ 52 \| 🐛 171 \| 📅 2026-09-04                    | Allows full-text search and access preserved web content and related metadata. It is also possible to search by URL, accessing all versions of preserved web content. API returns a JSON object. | FREE  |
...
| PicImageSearch                   | <https://github.com/kitUIN/PicImageSearch> ⭐ 726 \| 🐛 5 \| 🌐 Python \| 📅 2026-09-25                    | Aggregator for different Reverse Image Search API                                                                                                                                                | FREE? (no official)                |
...
| YouTube Music | <https://github.com/sigma67/ytmusicapi> ⭐ 3,027 \| 🐛 45 \| 🌐 Python \| 📅 2026-09-23                 | Unofficial APi for YouTube Music                                              | FREE  |
...
| Discord       | <https://github.com/discordjs/discord.js> ⭐ 26,825 \| 🐛 163 \| 🌐 TypeScript \| 📅 2026-09-21         | JavaScript library for interacting with the Discord API                       | FREE  |
...
| Name               | Link                                                                                                                         | Description                                                                                                                                                         | Price                |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Jackett            | <https://github.com/Jackett/Jackett> ⭐ 16,072 \| 🐛 218 \| 🌐 C# \| 📅 2026-09-25                                            | API for automate searching in different torrent trackers                                                                                                            | FREE                 |
...
| ---------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Keyhacks         | <https://github.com/streaak/keyhacks> ⭐ 6,343 \| 🐛 45 \| 📅 2026-08-07        | Keyhacks is a repository which shows quick ways in which API keys leaked by a bug bounty program can be checked to see if they're valid. |
...
| Public APIs Github repo | <https://github.com/public-apis/public-apis> ⭐ 483,121 \| 🐛 1,950 \| 🌐 Python \| 📅 2026-09-24 |             |

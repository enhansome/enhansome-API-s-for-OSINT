# Awesome API s for OSINT with stars
...
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/dwyl/esta/issues) ⭐ 49 | 🐛 0 | 🌐 JavaScript | 📅 2016-12-23 <p align="center">
...
| Social Links | <https://sociallinks.io/products/sl-api> | Email info lookup, phone info lookup, individual and company profiling, social media tracking, dark web monitoring and more. Code example of using this API for face search in this [repo](https://github.com/SocialLinks-IO/sociallinks-api) ⭐ 131 \| 🐛 1 \| 🌐 Python \| 📅 2025-04-15 | PAID. Price per request |
...
| Name             | Link                                                                                 | Description                                                                                                                                                       | Price                     |
| ---------------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| API OSINT DS     | <https://github.com/davidonzo/apiosintDS> ⭐ 59 \| 🐛 0 \| 🌐 Python \| 📅 2024-06-13 | Collect info about IPv4/FQDN/URLs and file hashes in md5, sha1 or sha256                                                                                          | FREE                      |
...
| Cloudflare Trace | <https://github.com/fawazahmed0/cloudflare-trace-api> ⭐ 194 \| 🐛 4 \| 📅 2024-08-20 | Get IP Address, Timestamp, User Agent, Country Code, IATA, HTTP Version, TLS/SSL Version & More                                                                   | FREE                      |
...
| LeekLookup          | <https://leak-lookup.com/api>                                  | search domain, email\_address, fullname, ip address, phone, password, username in leaks databases                                    | 10 requests FREE                   |
| BreachDirectory.org | <https://rapidapi.com/rohan-patra/api/breachdirectory/pricing> | search domain, email\_address, fullname, ip address, phone, password, username in leaks databases (possible to view password hashes) | 50 requests in month/FREE          |
...
| Arquivo.pt API                                                                   | <https://github.com/arquivo/pwa-technologies/wiki/Arquivo.pt-API> ⭐ 52 \| 🐛 160 \| 📅 2026-09-04                    | Allows full-text search and access preserved web content and related metadata. It is also possible to search by URL, accessing all versions of preserved web content. API returns a JSON object. | FREE  |
...
| Name                             | Link                                                                                                      | Description                                                                                                                                                                                      | Price                              |
| -------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- |
| Google Reverse images search API | <https://github.com/SOME-1HING/google-reverse-image-api/> ⭐ 132 \| 🐛 1 \| 🌐 JavaScript \| 📅 2024-11-16 | This is a simple API built using Node.js and Express.js that allows you to perform Google Reverse Image Search by providing an image URL.                                                        | FREE (UNOFFICIAL)                  |
...
| PicImageSearch                   | <https://github.com/kitUIN/PicImageSearch> ⭐ 726 \| 🐛 5 \| 🌐 Python \| 📅 2026-09-07                    | Aggregator for different Reverse Image Search API                                                                                                                                                | FREE? (no official)                |
...
| HackerNews                     | <https://github.com/HackerNews/API> ⭐ 13,314 \| 🐛 5 \| 📅 2025-01-01 | Social news for CS and entrepreneurship                                                           | FREE  |
...
| Name          | Link                                                                                                   | Description                                                                   | Price |
| ------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----- |
| TikTok        | <https://github.com/davidteather/TikTok-Api> ⭐ 6,622 \| 🐛 153 \| 🌐 Python \| 📅 2026-08-24           | The Unofficial TikTok API Wrapper In Python                                   | FREE  |
...
| YouTube Music | <https://github.com/sigma67/ytmusicapi> ⭐ 2,997 \| 🐛 46 \| 🌐 Python \| 📅 2026-09-01                 | Unofficial APi for YouTube Music                                              | FREE  |
| Duolingo      | <https://github.com/KartikTalwar/Duolingo> ⭐ 905 \| 🐛 40 \| 🌐 Python \| 📅 2024-04-12                | Duolingo unofficial API (can gather info about users)                         | FREE  |
...
| Instagram     | <https://github.com/ping/instagram_private_api> ⭐ 3,303 \| 🐛 160 \| 🌐 Python \| 📅 2024-05-06        | Instagram Private API                                                         | FREE  |
| Discord       | <https://github.com/discordjs/discord.js> ⭐ 26,817 \| 🐛 161 \| 🌐 TypeScript \| 📅 2026-09-10         | JavaScript library for interacting with the Discord API                       | FREE  |
...
| PornHub       | <https://github.com/sskender/pornhub-api> ⭐ 458 \| 🐛 7 \| 🌐 Python \| 📅 2023-12-30                  | Unofficial API for PornHub in Python                                          | FREE  |
...
| Google Search | <https://github.com/aviaryan/python-gsearch> ⭐ 220 \| 🐛 10 \| 🌐 Python \| 📅 2021-02-06              | Google Search unofficial API for Python with no external dependencies         | FREE  |
| Airbnb        | <https://github.com/nderkach/airbnb-python> ⭐ 203 \| 🐛 16 \| 🌐 Python \| 📅 2022-12-08               | Python wrapper around the Airbnb API (unofficial)                             | FREE  |
| Medium        | <https://github.com/enginebai/PyMedium> ⭐ 165 \| 🐛 8 \| 🌐 Python \| 📅 2021-03-19                    | Unofficial Medium Python Flask API and SDK                                    | FREE  |
| Facebook      | <https://github.com/davidyen1124/Facebot> ⚠️ Archived                                                  | Powerful unofficial Facebook API                                              | FREE  |
| Linkedin      | <https://github.com/tomquirk/linkedin-api>                                                             | Unofficial Linkedin API for Python                                            | FREE  |
| Y2mate        | <https://github.com/Simatwa/y2mate-api> ⚠️ Archived                                                    | Unofficial Y2mate API for Python                                              | FREE  |
| Livescore     | <https://github.com/Simatwa/livescore-api> ⭐ 4 \| 🐛 0 \| 🌐 Python \| 📅 2025-06-25                   | Unofficial Livescore API for Python                                           | FREE  |
...
| Name               | Link                                                                                                                        | Description                                                                                                                                                         | Price                |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Jackett            | <https://github.com/Jackett/Jackett> ⭐ 16,015 \| 🐛 210 \| 🌐 C# \| 📅 2026-09-10                                           | API for automate searching in different torrent trackers                                                                                                            | FREE                 |
...
| Torrentinim        | <https://github.com/sergiotapia/torrentinim> ⭐ 827 \| 🐛 9 \| 🌐 Nim \| 📅 2024-01-29                                       | Very low memory-footprint, self hosted API-only torrent search engine. Sonarr + Radarr Compatible, native support for Linux, Mac and Windows.                       | FREE                 |
...
| ---------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Keyhacks         | <https://github.com/streaak/keyhacks> ⭐ 6,335 \| 🐛 45 \| 📅 2026-08-07        | Keyhacks is a repository which shows quick ways in which API keys leaked by a bug bounty program can be checked to see if they're valid. |
| All about APIKey | <https://github.com/daffainfo/all-about-apikey> ⭐ 301 \| 🐛 1 \| 📅 2023-09-26 | Detailed information about API key / OAuth token for different services (Description, Request, Response, Regex, Example)                 |
...
| Public APIs Github repo | <https://github.com/public-apis/public-apis> ⭐ 478,440 \| 🐛 1,929 \| 🌐 Python \| 📅 2026-09-09 |             |

...
| Cloudflare Trace | <https://github.com/fawazahmed0/cloudflare-trace-api> ⭐ 193 \| 🐛 4 \| 📅 2024-08-20 | Get IP Address, Timestamp, User Agent, Country Code, IATA, HTTP Version, TLS/SSL Version & More                                                                   | FREE                      |
...
| Arquivo.pt API                                                                   | <https://github.com/arquivo/pwa-technologies/wiki/Arquivo.pt-API> ⭐ 52 \| 🐛 154 \| 📅 2026-07-15                    | Allows full-text search and access preserved web content and related metadata. It is also possible to search by URL, accessing all versions of preserved web content. API returns a JSON object. | FREE  |
...
| Name                             | Link                                                                                                      | Description                                                                                                                                                                                      | Price                              |
| -------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- |
| Google Reverse images search API | <https://github.com/SOME-1HING/google-reverse-image-api/> ⭐ 131 \| 🐛 1 \| 🌐 JavaScript \| 📅 2024-11-16 | This is a simple API built using Node.js and Express.js that allows you to perform Google Reverse Image Search by providing an image URL.                                                        | FREE (UNOFFICIAL)                  |
...
| PicImageSearch                   | <https://github.com/kitUIN/PicImageSearch> ⭐ 718 \| 🐛 4 \| 🌐 Python \| 📅 2026-08-12                    | Aggregator for different Reverse Image Search API                                                                                                                                                | FREE? (no official)                |
...
| HackerNews                     | <https://github.com/HackerNews/API> ⭐ 13,254 \| 🐛 5 \| 📅 2025-01-01 | Social news for CS and entrepreneurship                                                           | FREE  |
...
| Name          | Link                                                                                                   | Description                                                                   | Price |
| ------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----- |
| TikTok        | <https://github.com/davidteather/TikTok-Api> ⭐ 6,559 \| 🐛 151 \| 🌐 Python \| 📅 2026-07-03           | The Unofficial TikTok API Wrapper In Python                                   | FREE  |
...
| YouTube Music | <https://github.com/sigma67/ytmusicapi> ⭐ 2,934 \| 🐛 44 \| 🌐 Python \| 📅 2026-08-10                 | Unofficial APi for YouTube Music                                              | FREE  |
| Duolingo      | <https://github.com/KartikTalwar/Duolingo> ⭐ 902 \| 🐛 40 \| 🌐 Python \| 📅 2024-04-12                | Duolingo unofficial API (can gather info about users)                         | FREE  |
...
| Discord       | <https://github.com/discordjs/discord.js> ⭐ 26,776 \| 🐛 156 \| 🌐 TypeScript \| 📅 2026-08-10         | JavaScript library for interacting with the Discord API                       | FREE  |
...
| PornHub       | <https://github.com/sskender/pornhub-api> ⭐ 456 \| 🐛 7 \| 🌐 Python \| 📅 2023-12-30                  | Unofficial API for PornHub in Python                                          | FREE  |
...
| Name               | Link                                                                                                                        | Description                                                                                                                                                         | Price                |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Jackett            | <https://github.com/Jackett/Jackett> ⭐ 15,875 \| 🐛 204 \| 🌐 C# \| 📅 2026-08-12                                           | API for automate searching in different torrent trackers                                                                                                            | FREE                 |
...
| Torrentinim        | <https://github.com/sergiotapia/torrentinim> ⭐ 822 \| 🐛 9 \| 🌐 Nim \| 📅 2024-01-29                                       | Very low memory-footprint, self hosted API-only torrent search engine. Sonarr + Radarr Compatible, native support for Linux, Mac and Windows.                       | FREE                 |
...
| ---------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Keyhacks         | <https://github.com/streaak/keyhacks> ⭐ 6,312 \| 🐛 47 \| 📅 2026-08-07        | Keyhacks is a repository which shows quick ways in which API keys leaked by a bug bounty program can be checked to see if they're valid. |
| All about APIKey | <https://github.com/daffainfo/all-about-apikey> ⭐ 299 \| 🐛 1 \| 📅 2023-09-26 | Detailed information about API key / OAuth token for different services (Description, Request, Response, Regex, Example)                 |
...
| Public APIs Github repo | <https://github.com/public-apis/public-apis> ⭐ 455,759 \| 🐛 1,638 \| 🌐 Python \| 📅 2026-08-12 |             |

...
| Arquivo.pt API                                                                   | <https://github.com/arquivo/pwa-technologies/wiki/Arquivo.pt-API> ⭐ 52 \| 🐛 158 \| 📅 2026-09-04                    | Allows full-text search and access preserved web content and related metadata. It is also possible to search by URL, accessing all versions of preserved web content. API returns a JSON object. | FREE  |
...
| PicImageSearch                   | <https://github.com/kitUIN/PicImageSearch> ⭐ 726 \| 🐛 5 \| 🌐 Python \| 📅 2026-09-12                    | Aggregator for different Reverse Image Search API                                                                                                                                                | FREE? (no official)                |
...
| HackerNews                     | <https://github.com/HackerNews/API> ⭐ 13,321 \| 🐛 5 \| 📅 2025-01-01 | Social news for CS and entrepreneurship                                                           | FREE  |
...
| Name          | Link                                                                                                   | Description                                                                   | Price |
| ------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----- |
| TikTok        | <https://github.com/davidteather/TikTok-Api> ⭐ 6,624 \| 🐛 153 \| 🌐 Python \| 📅 2026-08-24           | The Unofficial TikTok API Wrapper In Python                                   | FREE  |
...
| YouTube Music | <https://github.com/sigma67/ytmusicapi> ⭐ 3,002 \| 🐛 48 \| 🌐 Python \| 📅 2026-09-01                 | Unofficial APi for YouTube Music                                              | FREE  |
...
| Discord       | <https://github.com/discordjs/discord.js> ⭐ 26,821 \| 🐛 164 \| 🌐 TypeScript \| 📅 2026-09-11         | JavaScript library for interacting with the Discord API                       | FREE  |
...
| PornHub       | <https://github.com/sskender/pornhub-api> ⭐ 459 \| 🐛 7 \| 🌐 Python \| 📅 2023-12-30                  | Unofficial API for PornHub in Python                                          | FREE  |
...
| Name               | Link                                                                                                                        | Description                                                                                                                                                         | Price                |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Jackett            | <https://github.com/Jackett/Jackett> ⭐ 16,024 \| 🐛 222 \| 🌐 C# \| 📅 2026-09-12                                           | API for automate searching in different torrent trackers                                                                                                            | FREE                 |
...
| ---------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Keyhacks         | <https://github.com/streaak/keyhacks> ⭐ 6,337 \| 🐛 45 \| 📅 2026-08-07        | Keyhacks is a repository which shows quick ways in which API keys leaked by a bug bounty program can be checked to see if they're valid. |
...
| Public APIs Github repo | <https://github.com/public-apis/public-apis> ⭐ 479,223 \| 🐛 1,952 \| 🌐 Python \| 📅 2026-09-10 |             |
